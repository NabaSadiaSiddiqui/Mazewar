...
public class Mazewar extends JFrame {
	...
	public static void respawn(Point point, Direction d) {
		...
		ClientMulticast.mCast(MazewarPacket.CLIENT_RESPAWN, newPos);
	...
	public static void mQuit() {
		ClientMulticast.mCast(MazewarPacket.CLIENT_QUIT, null);
	}

	public static void mForward() {
		ClientMulticast.mCast(MazewarPacket.CLIENT_FORWARD, null);
	}

	public static void mBackup() {
		ClientMulticast.mCast(MazewarPacket.CLIENT_BACKWARD, null);
	}

	public static void mFire() {
		ClientMulticast.mCast(MazewarPacket.CLIENT_FIRE, null);
	}

	public static void mLeft() {
		ClientMulticast.mCast(MazewarPacket.CLIENT_LEFT, null);
	}

	public static void mRight() {
		ClientMulticast.mCast(MazewarPacket.CLIENT_RIGHT, null);
	}
}
