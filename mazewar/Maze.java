...
public abstract class Maze {
	 ...
	 *         maximum X coordintate, and the method <code>getY</code> returns
	 ...
	 * 
	 * @param occupiedCells
	 *            All unavailable points on the maze
	 ...
	 *            {@link Client} to be added to the {@link Maze}
	 * @param point
	 *            {@link Point} at which to add the {@link Client}.
	 */
	 ...
	 *            {@link Point} at which to add the {@link Client}.
	 * @param direction
	 *            {@link Direction} which the client will be facing
	 */
	public abstract void addClientAtPointWithDirection(Client client,
